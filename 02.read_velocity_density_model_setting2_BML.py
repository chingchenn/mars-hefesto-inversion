...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 21:09:05 2026
...
#          25_EM1_BML_Mg55,
#          26_EM1_BML_Mg50]
HEFESTO_FILE = '/Users/chingchen/Desktop/HeFESTo/02_YM_bulk_mantle_BML_T/fort.56'
...
# axr.plot(hef_vp, hef_P, color=colors[2], lw=2.2, ls='--', label='HeFESTo Vp')
# axr.plot(hef_vs, hef_P, color=colors[0], lw=2.2, ls='--', label='HeFESTo Vs')
